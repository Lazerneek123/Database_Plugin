...
import com.example.demo.inputDialog.InputDEntityAdvancedSettings
...
class ActCreateTableAdvancedSettings : AnAction() {
    ...
    private fun messageShowInputDialog(
        ...
        val inputDialog = InputDEntityAdvancedSettings()
    ...
    private fun createKotlinFile(
        ...
        packagePath: String,
        fileName: String,
        inputDialog: InputDEntityAdvancedSettings,
        event: AnActionEvent
    ) {
        try {
